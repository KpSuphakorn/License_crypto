...
export default function LicenseManagementDashboard() {
  ...
  const handleDownloadLogs = async () => {
    try {
      ...
      a.href = url;
      a.download = `usage-logs-${new Date().toISOString().split('T')[0]}${downloadFilters.start_date || downloadFilters.end_date ? `_${downloadFilters.start_date || 'all'}_to_${downloadFilters.end_date || 'all'}` : ''}.csv`;
          ...
          <div className="fixed inset-0 bg-gray-900/30 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl p-6 w-full max-w-md">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">License ID (Optional)</label>
                  <input
                    type="text"
                    name="license_id"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Action (Optional)</label>
                  <select
                    name="action"
                  ...
                  >
                    ...
                    <option value="request_license">Request License</option>
                    <option value="activate_license">Activate License</option>
                    <option value="release_license">Release License</option>
