        ...
        <form>
          <div className="mt-4">
            ...
            <div className="flex items-baseline justify-center mt-6">
              <button className="w-full px-6 py-2 mt-4 text-white bg-blue-800 rounded-lg hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50">เข้าสู่ระบบ</button>
            </div>
            <div className="flex items-baseline justify-center mt-4">
              <Link href="/register" passHref>
                <button className="w-full px-6 py-2 text-blue-800 border border-blue-800 rounded-lg hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50">ลงทะเบียน</button>
              </Link>
            </div>
          </div>
        </form>
